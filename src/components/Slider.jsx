...
import SliderImg from "../../public/img/blackkhuman.svg";

const images = [
  <div className="relative flex h-full max-w-[1300px] mx-auto w-full bg-[#E5E4ED]">
        ...
        {images.map((_, index) => (
          <button
            ...
            className={`mx-1 h-3 rounded-full transition duration-500 ease-in-out ${
              index === currentIndex ? "w-12 bg-[#7A7687]" : "w-3 bg-[#B9B6BC]"
            }`}
