  ...
  return (
    <div class="mx-auto mb-[150px] px-5 max-w-[1300px]">
      ...
      <div class="flex gap-[10px]">
        <div class="flex w-full flex-col items-center justify-center rounded-[10px] border border-[E5E2EE] lg:h-[320px]">
          <i class="mb-10">
            <svg
          ...
          <p class="font-medium leading-[140%]">Быстрая доставка</p>
        </div>
        <div class="flex w-full flex-col items-center justify-center rounded-[10px] border border-[E5E2EE] lg:h-[320px]">
          <i class="mb-10">
            <svg
          ...
          <p class="font-medium leading-[140%]">Весь товар сертифицирован</p>
        </div>
        <div class="flex w-full flex-col items-center justify-center rounded-[10px] border border-[E5E2EE] lg:h-[320px]">
          <i class="mb-10">
            <svg
          ...
          <p class="font-medium leading-[140%]">Гибкая система скидок</p>
        </div>
        <div class="flex w-full flex-col items-center justify-center rounded-[10px] border border-[E5E2EE] lg:h-[320px]">
          <i class="mb-10">
            <svg
      ...
      <div className="bg-[#088269]">
        <div class="flex justify-between border-b border-[#F8F7F3] pb-14 pt-10 px-5">
          <div>
            <h3 class="mb-4 border-b border-[#F8F7F3] pb-4 text-sm font-semibold text-[#F8F7F3]">
              Покупателям
            </h3>
            <div class="flex gap-[60px]">
              <ul class="flex flex-col gap-y-2">
                <li class="text-sm font-normal text-[#F8F7F3]">
                  <a href="/">О компании</a>
                </li>
                <li class="text-sm font-normal text-[#F8F7F3]">
          ...
          <div>
            ...
            <div class="flex gap-[60px]">
              ...
              <ul class="flex flex-col gap-y-2">
                <li class="text-sm font-normal text-[#F8F7F3]">
                  <a href="/">Орториноларингология</a>
                </li>
                <li class="text-sm font-normal text-[#F8F7F3]">
                  <a href="/">Рентгенология и томография</a>
                </li>
                <li class="text-sm font-normal text-[#F8F7F3]">
                  <a href="/">Стрерилизация</a>
                </li>
                <li class="text-sm font-normal text-[#F8F7F3]">
                  <a href="/">Физиотерапия и реабилитация</a>
                </li>
                <li class="text-sm font-normal text-[#F8F7F3]">
          ...
          <div>
            ...
            <ul>
              <li class="mb-6">
                <h4 class="mb-1 text-sm font-semibold text-[#F8F7F3]">
                  Адрес:
                </h4>
                <p class="text-sm font-normal text-[#F8F7F3]">
                  г. Москва, ул. Московская, д. 35
                </p>
              </li>
              <li class="mb-6 flex items-center gap-2">
                <a class="mb-1 text-sm font-semibold text-[#F8F7F3]" href="/">
                  Карта проезда
                </a>
                <i>
                  <svg
              ...
              <li class="flex flex-col gap-y-[5px]">
                <p class="text-sm font-normal text-[#F8F7F3]">
                  +7 000-000-00-00
                </p>
                <p class="text-sm font-normal text-[#F8F7F3]">
                ...
                <a
                  class="text-sm font-normal text-[#F8F7F3]"
      ...
      <div class="mb-14 pt-4 bg-[#088269] ">
        <ul class="flex justify-between">
          <li>
            <a href="/">
              <svg
                ...
                fill="none"
              >
                <g clip-path="url(#clip0_36_13714)">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                ...
                <defs>
                  <clipPath id="clip0_36_13714">
                    <rect width="95.8406" height="41" fill="white"></rect>
                  </clipPath>
                </defs>
              </svg>
            </a>
            <p class="mt-3 text-[12px] font-normal text-[#F8F7F3]">
              ООО «ГЛОБАЛ МЕДИКАЛ ТРЕЙД»
            </p>
          </li>
          <li>
            <p class="mb-3 text-sm font-semibold text-[#F8F7F3]">
              Мы в соцсетях
            </p>
            <div class="flex gap-[10px]">
              <a href="/">
          ...
          <li class="flex flex-col gap-y-2">
            <a class="text-sm font-normal text-[#f8f7f3]" href="/">
          ...
          <li class="flex flex-col gap-y-2">
            <p class="text-sm font-normal text-[#f8f7f3]">Способы оплаты</p>
